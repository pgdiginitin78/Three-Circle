      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        <FadeUpText>
          <div className="mb-10 md:mb-14">
            <span className="font-display text-[9px] sm:text-[10px] font-extrabold tracking-[0.35em] text-brand-gold uppercase block mb-2.5">
              By The Numbers
            </span>
            ...
            <BentoCard key={i} index={i} className="p-0">
              <SpotlightCard className="h-full w-full p-6 sm:p-8 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between w-full mb-6">
                  <span className="font-mono text-[10px] font-bold tracking-widest text-brand-gold uppercase">
                    0{i + 1}
                  </span>
                ...
                <div>
                  <div className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-text-primary flex items-baseline select-none mb-3">
                    ...
                    <span className="text-brand-gold ml-0.5 text-3xl sm:text-4xl lg:text-5xl font-black">
                      {stat.suffix}
                    </span>
                  </div>

                  {/* Gold Divider Line */}
                  <div className="w-8 h-[2px] bg-brand-gold my-3.5 rounded-full transition-all duration-500 group-hover:w-16" />
